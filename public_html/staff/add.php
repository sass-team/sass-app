                ...
                <div class="col-md-9 col-sm-7">
                    ...
                    <div id="myTabContent" class="tab-content stacked-content">
                        <div class="tab-pane fade in active" id="add">
                            <p>In this section admin is able to add a new user
                                and fill out the appropriate fields. Only
                                necessary fields are required in order to create
                                a new user. Users(tutors or
                                secretaries)
                                are
                                able to modify some of their profile data nce
                                they are logged in.</p>

                            <p>
                                <a data-toggle="modal" id="btnAddUserModal"
                                   href="#styledModal" class="btn btn-primary">
                            ...
                            if (empty($errors) === false) {
                                ...
                                if (is_create_bttn_Pressed()) {
                                    ...
                                    <div class="alert alert-success">
                                        <a class="close" data-dismiss="alert"
                                           href="#" aria-hidden="true">×</a>
                                        <strong>staff member successfully
                                            created!</strong> <br/>
                                        An email is being sent to the email you
                                        just specified, with next steps to
                                        follow.
                                    </div>
                                <?php }
                            } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <h5>
                                                <i class="fa fa-tasks"></i>
                                                <label for="termIds">Current
                                                    Terms</label>
                                            </h5>
                                            <select id="termIds" name="termIds"
                                                    class="form-control"
                                                    required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <h5>
                                                <i class="fa fa-tasks"></i>
                                                <label for="teachingCoursesMulti">Tutor's
                                                    Courses</label>
                                            </h5>

                                            <select id="teachingCoursesMulti"
                                                    name="teachingCoursesMulti[]"
                                                    class="form-control"
                                                    multiple>
