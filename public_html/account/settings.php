			...
			<div class="row">
						...
						<div class="tab-pane fade in active" id="profile-tab">
							...
							<form action="<?php echo BASE_URL; ?>account/settings" class="form-horizontal" method="post"
									...
									<div class="col-md-7">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="width: 180px; height: 180px;">
												<img
													src="<?php echo BASE_URL . $user->getAvatarImgLoc() ?>"
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" name="firstName" id="firstName"
										       ...
										       class="form-control" required <?php if (!$user->isAdmin())
										{
											echo "disabled";
										} ?>/>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" name="newMobileNum" id="newMobileNum"
										       value="<?php echo $user->getMobileNum(); ?>"
										       class="form-control"/>
									</div>
									<!-- /.col -->
				...
				<textarea id="profileDescription" name="profileDescription" rows="6"
						...
						<div class="tab-pane fade" id="password-tab">
							...
							<form action="<?php echo BASE_URL; ?>account/settings" class="form-horizontal"
							      method="post">
