...
class User extends Person
{
    ...
    /**
     * Returns all information of a user given an id.
     * @param $id
     * @return mixed
     * @throws Exception
     * @internal param $db
    ...
    /** Return a single column from the next row of a result set or FALSE if there are no more rows. */
    ...
    public static function generateSetPasswordLink(User $user)
    {
        $userId = $user->getId();

        $getString = User::generateNewPasswordString($userId);

        return App::getDomainName() . "/login/set/" . $userId . "/" . $getString;
    }
