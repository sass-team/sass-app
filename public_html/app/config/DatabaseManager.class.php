...
// production
	public static $dsn = array(
		self::DB_HOST => 'mysql.hostinger.gr',
		self::DB_USERNAME => 'u482024869_sassu',
		self::DB_PASSWORD => 'RBNXrlIhMRdDwj4f0bdd',
		self::DB_NAME => 'u482024869_sassd',
		self::DB_PORT => '3306'
	);
	...
	private function __construct() {
		try { // connects to database
			...
			$this->dbConnection->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT); // CHANGE THE ERROR MODE, THROW AN EXCEPTION WHEN AN ERROR IS FOUND
