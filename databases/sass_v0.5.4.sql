...
INSERT INTO `course` VALUES (1,'2186','Computer System Architecture',4),(2,'2234','Object Oriented Programming',5),(3,'3157','Project Management',6),(4,'2201','Contemporary Mass Communication',4),(5,'2206','Interpersonal Communication',NULL);
...
CREATE TABLE `tutor_teaches_courses` (
  ...
  CONSTRAINT `fk_tutor_teaches_courses_tutor1` FOREIGN KEY (`tutor_user_id`) REFERENCES `sass-ms`.`tutor` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'admin@acg.edu','admini','Dokollar','$2y$10$FU6MywJG1EENkmAqobhQH.lH9FesQ8uKlXW/CaIqeyXKjJNWt.uhC','img/avatars/default_avatar.jpg','2014-08-20 15:27:53',7,'6983827754','Lover, Hacker, Vault Dwellerd','53f4aeb7cde698.15572569LFOEPQSXCJ'),(8,'tutor@acg.edu3','tutora','lastaadsf','$2y$10$C63yikwmfa5Zj0RKga1q9evG5GS8.x8tFcm4AGDYVHa6wdiAnFNca','app/assets/img/avatars/default_avatar.jpg','2014-08-20 19:47:15',9,'6983827752','adsfasdf',''),(9,'secretary@acg.edu','secretary','last','$2y$10$OrqiUU9RScyoEYCf.bZFNORcjJj1tDASbSlWy.G7MCLRTjmUf.9ZC','app/assets/img/avatars/default_avatar.jpg','2014-08-20 15:27:53',8,'6983827750','adfads','');
...
-- Dump completed on 2014-08-21  8:35:02
