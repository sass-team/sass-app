...
INSERT INTO `appointment` VALUES (4,'2014-09-17 03:38:00','2014-09-17 04:08:00',4,3,3),(5,'2014-09-17 05:25:00','2014-09-17 05:55:00',4,3,3),(6,'2014-09-17 05:26:00','2014-09-17 05:56:00',4,3,3),(7,'2014-09-17 07:30:00','2014-09-17 09:30:00',4,3,3);
...
CREATE TABLE `appointment_has_student_has_report_has_instructor` (
  ...
  KEY `fk_appointment_has_student_has_report_has_instructor_report_idx` (`report_id`),
  ...
  CONSTRAINT `fk_appointment_has_student_has_report_has_instructor_report1` FOREIGN KEY (`report_id`) REFERENCES `sass-ms_db`.`report` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `appointment_has_student_has_report_has_instructor` VALUES (3,4,3,1,NULL),(4,5,3,1,NULL),(5,6,3,1,NULL),(6,7,3,1,NULL);
...
INSERT INTO `course` VALUES (3,'CC','course',NULL),(4,'CCC','courses',NULL);
...
INSERT INTO `instructor` VALUES (1,'first','last'),(2,'instructor first name','instructor last name');
...
INSERT INTO `major` VALUES (2,'Undecided','UN');
...
INSERT INTO `student` VALUES (3,1223344,'emai@email.com','student first','student last','6983827751',NULL,NULL,2),(4,1223345,'rdok.dev.axionagro@gmail.com','student se','student le','6983827750',NULL,NULL,2);
...
INSERT INTO `term` VALUES (2,'Fall Semester 2014','2014-09-16 16:39:00','2014-12-15 17:39:00'),(3,'Fall Semester 2015','2014-09-30 16:40:00','2015-02-24 17:40:00');
...
INSERT INTO `tutor` VALUES (3,2),(5,2);
...
INSERT INTO `tutor_has_course_has_term` VALUES (3,3,4,3),(3,4,5,3);
...
INSERT INTO `user` VALUES (2,'r.dokollari@acg.edu','','','$2y$10$EgCEBg0hDX1oNmgGcqYUx.2DwwIp5PyaVjADpyd8bIll/3szToeTK','assets/img/avatars/default_avatar.jpg','2014-09-16 16:26:42',4,NULL,NULL,1,'','2014-09-16 16:26:54'),(3,'emai@email.com2','tutor','last',NULL,'assets/img/avatars/default_avatar.jpg','2014-09-16 20:35:57',6,NULL,NULL,1,'54189f2d558543.32134595KHXFQJOBWY','2014-09-16 20:35:57'),(5,'emai@email.com3','first','last',NULL,'assets/img/avatars/default_avatar.jpg','2014-09-16 22:14:54',6,NULL,NULL,1,'5418b65ebebf94.36194059JGLHONAEZB','2014-09-16 22:14:54');
...
-- Dump completed on 2014-09-17  8:34:45
