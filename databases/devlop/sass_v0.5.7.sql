...
INSERT INTO `course` VALUES (1,'2186','Computer System Architecture',4),(2,'2234','Object Oriented Programming',5),(3,'3157','Project Management',6),(4,'2201','Contemporary Mass Communication',4),(5,'2206','Interpersonal Communication',NULL),(6,'1234','course',NULL),(10,'1','asdf',NULL),(11,'12','name',NULL),(14,'14','padsf',NULL);
...
INSERT INTO `instructor` VALUES (1,'instructor','Dokollar','emai@email.com'),(2,'instructorr','Dokollar','emai@email.com2'),(3,'instructorr','Dokollar','emai@email.com3'),(4,'instructorrr','Dokollar','emai@email.com4');
...
CREATE TABLE `instructor_has_course` (
  ...
  CONSTRAINT `fk_instructor_has_course_course1` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_instructor_has_course_instructor1` FOREIGN KEY (`instructor_id`) REFERENCES `instructor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student` VALUES (1,'email@email.com','rdz','dok',NULL,NULL,NULL),(4,'email2@email.com','k','',NULL,NULL,NULL);
...
INSERT INTO `tutor_has_course` VALUES (8,3),(8,4),(8,5);
...
DROP TABLE IF EXISTS `tutor_has_major`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tutor_has_major` (
  `tutor_user_id` int(11) NOT NULL,
  `major_id` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_tutor_has_major_tutor1` FOREIGN KEY (`tutor_user_id`) REFERENCES `tutor` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tutor_has_major_major1` FOREIGN KEY (`major_id`) REFERENCES `major` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tutor_has_major`
--

LOCK TABLES `tutor_has_major` WRITE;
/*!40000 ALTER TABLE `tutor_has_major` DISABLE KEYS */;
/*!40000 ALTER TABLE `tutor_has_major` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (1,'admin@acg.edu','aSzfss','aSsadewd','$2y$10$EHP4vZFbS6DgpQvNkc9ODeprPoNxFvonCLoDWndS./sGymx/Azehu','img/avatars/default_avatar.jpg','2014-08-23 18:55:33',7,'6983827753','a \r\nd_a -d\r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa ,.\r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\nd_sssssssssssssssssssssssa \r\n\r\n','53f4aeb7cde698.15572569LFOEPQSXCJ',1),(8,'tutor@acg.edud','tutord','last','$2y$10$C63yikwmfa5Zj0RKga1q9evG5GS8.x8tFcm4AGDYVHa6wdiAnFNca','app/assets/img/avatars/default_avatar.jpg','2014-08-24 06:57:21',9,'6983827752','adsfasdf','',1),(9,'secretary@acg.edu','secretary','lastl','$2y$10$OrqiUU9RScyoEYCf.bZFNORcjJj1tDASbSlWy.G7MCLRTjmUf.9ZC','app/assets/img/avatars/default_avatar.jpg','2014-08-23 18:52:52',8,'6983827751','adfads','',1),(10,'tutor2@acg.edu','tutorr','last',NULL,'app/assets/img/avatars/default_avatar.jpg','2014-08-23 17:32:31',9,NULL,NULL,NULL,1),(11,'tutor2@acg.edue','tutorr','last',NULL,'app/assets/img/avatars/default_avatar.jpg','2014-08-23 17:33:06',9,NULL,NULL,NULL,1);
...
-- Dump completed on 2014-08-24 10:41:21
