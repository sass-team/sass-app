...
INSERT INTO `course` VALUES (15,'12','course',NULL),(17,'13','coursen',NULL);
...
INSERT INTO `instructor` VALUES (5,'instructor','last','emai@email.com');
...
INSERT INTO `student` VALUES (5,'emai@email.com','firstfirst','last',0,0,0),(12,'emai@email.com2','first','last',NULL,0,0),(13,'emai@email.com3','first','last',1234567980,0,0),(14,'emai@email.com4','first','last',NULL,3.5,100),(15,'emai@email.com5','first','last',NULL,NULL,0),(16,'emai@email.com6','first','last',NULL,NULL,NULL),(17,'emai@email.com7','first','last',1234567891,3.5,100);
...
INSERT INTO `tutor` VALUES (18),(19);
...
INSERT INTO `tutor_has_course` VALUES (18,17,3);
...
CREATE TABLE `tutor_has_major` (
  ...
  CONSTRAINT `fk_tutor_has_major_major1` FOREIGN KEY (`major_id`) REFERENCES `major` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_tutor_has_major_tutor1` FOREIGN KEY (`tutor_user_id`) REFERENCES `tutor` (`user_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (13,'admin@acg.edu','acg','lnames','$2y$10$/J0oVfPHQAWsF0zTNAeuceBSIaN0anGQkJv83ldeZtajcJ5bMiDCK','app/assets/img/avatars/default_avatar.jpg','2014-09-02 10:21:37',10,'1234566791','asdfsf','',1),(18,'tutor@acg.edu','tutor','last','$2y$10$PN8uUAgggjqC/1swaPvz2Ogio7Davj1MqiitftgvoaWfTpip.uDom','app/assets/img/avatars/default_avatar.jpg','2014-09-02 10:22:45',11,'',NULL,'',1),(19,'emai@email.com','Rizart','Dokollari','$2y$10$hlK5Rfv0Pqe39Oij5lJMeurDIne3aHjKoA6U4PvDSIcWzVhWHJGbu','app/assets/img/avatars/default_avatar.jpg','2014-09-13 03:33:44',11,NULL,'dasfasdfa','',1),(20,'secretary@acg.edu','secretary','last','$2y$10$XLCI.yB5T2Xf8yMHfGPKHO2Wk.cnK0ekIiPW1v0S2FvWJfdAobY4.','app/assets/img/avatars/default_avatar.jpg','2014-09-13 03:49:12',12,NULL,NULL,'',1);
...
INSERT INTO `user_types` VALUES (10,'admin'),(12,'secretary'),(11,'tutor');
...
-- Dump completed on 2014-09-13  6:49:56
