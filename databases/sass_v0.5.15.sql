...
INSERT INTO `course` VALUES (18,'1234','name',NULL),(19,'12','coursed',NULL);
...
INSERT INTO `instructor` VALUES (1,'first','last','emai@email.com');
...
INSERT INTO `major` VALUES (4,'Undecided','00'),(5,'ITC','01');
...
INSERT INTO `student` VALUES (9,123456,'emai@email.com2','first','last','6983827751',3.5,100,4),(10,123458,'emai@email.com','firstdd','lastt','6983827753',3.5,19,4);
...
CREATE TABLE `tutor` (
  ...
  CONSTRAINT `fk_tutor_major1` FOREIGN KEY (`major_id`) REFERENCES `sass-ms_db`.`major` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (20,'admin@acg.edu','admin','last','$2y$10$vgbNFZqdQRujz0zsm9AvhuJ1CgiAvr72ZUMwne5Lh2/yjTcRgc0fS','app/assets/img/avatars/default_avatar.jpg','2014-09-13 09:20:02',13,NULL,NULL,'',1),(21,'emai@email.com','tutor','last',NULL,'app/assets/img/avatars/default_avatar.jpg','2014-09-13 17:32:51',15,NULL,NULL,NULL,1),(22,'emai@email.com2','first','last',NULL,'app/assets/img/avatars/default_avatar.jpg','2014-09-13 18:49:13',15,NULL,NULL,NULL,1),(23,'emai@email.com4','first','last',NULL,'app/assets/img/avatars/default_avatar.jpg','2014-09-13 18:49:37',15,NULL,NULL,NULL,1),(24,'emai@email.com5','first','last',NULL,'app/assets/img/avatars/default_avatar.jpg','2014-09-13 18:51:44',15,NULL,NULL,NULL,1);
...
INSERT INTO `user_types` VALUES (13,'admin'),(14,'secretary'),(15,'tutor');
...
-- Dump completed on 2014-09-13 22:15:30
