...
INSERT INTO `major` VALUES (1,'IT','ext');
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `fk_student_major1` FOREIGN KEY (`major_id`) REFERENCES `major` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
INSERT INTO `student` VALUES (2,16434,'edmail','wema','last',NULL,NULL,NULL,1),(5,136434,'Dedmail','weSma','lDast',NULL,NULL,NULL,NULL),(9,1364343,'DeDdmail','weSmDa','lDDast',NULL,NULL,NULL,1),(14,23424,'ASF','SADF','ASDF',NULL,NULL,NULL,NULL);
...
INSERT INTO `user` VALUES (21,'admin@acg.edu','','','$2y$10$R1pqdA013nZLsmL7ReOmnOAXRTPcb5e9blxcyv5CkNlchxSrFuLmi','app/assets/img/avatars/default_avatar.jpg','2014-09-13 07:26:27',13,NULL,NULL,'',1);
...
INSERT INTO `user_types` VALUES (13,'admin');
...
-- Dump completed on 2014-09-13 10:43:33
