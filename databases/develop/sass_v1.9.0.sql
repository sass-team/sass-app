...
INSERT INTO `appointment` VALUES (34,'2014-09-23 19:00:00','2014-09-23 19:30:00',10,19,9,'complete','success'),(35,'2014-11-04 22:00:00','2014-11-04 22:30:00',10,19,9,'pending','default'),(36,'2014-10-24 23:00:00','2014-10-24 23:30:00',10,19,9,'no show by tutor','danger');
...
INSERT INTO `appointment_has_student` VALUES (35,34,8,85,2),(36,35,8,NULL,2),(37,36,8,NULL,2);
...
INSERT INTO `conclusion_wrap_up` VALUES (61,0,0,0),(62,0,0,0),(64,0,0,0),(67,1,1,1),(79,1,1,1),(80,1,1,1),(81,1,0,1),(82,0,0,0),(83,0,0,0),(85,0,0,0);
...
CREATE TABLE `dropbox` (
  ...
  KEY `fk_dropbox_user1_idx` (`user_id`),
  CONSTRAINT `fk_dropbox_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dropbox` VALUES ('pS_pf-E9KBUAAAAAAAAYM3aBzMqzeVpLMPDnXx4c0BU',17,'service_app_database_backup');
...
INSERT INTO `primary_focus_of_conference` VALUES (61,0,0,0,0,0,0,0),(79,1,1,1,1,1,1,1),(80,0,0,0,1,0,0,0),(81,1,1,1,0,0,0,0),(82,0,0,0,0,0,0,1),(83,1,1,1,1,1,1,1),(85,0,0,0,0,0,0,0);
...
INSERT INTO `report` VALUES (59,9,2,'',NULL,NULL,NULL,'pending fill','warning',NULL),(61,8,2,'',NULL,NULL,NULL,'pending fill','warning',NULL),(62,8,3,'',NULL,NULL,NULL,'pending fill','warning',NULL),(64,8,2,'',NULL,NULL,NULL,'pending fill','warning',NULL),(67,9,2,'dafdsfdasfasdfasdfa','fasdfasdfasdfasdfasdf','sdfsdafsdfasdfasdfasdfasdfasdfasdfasdfs','asdfasdfasdfasdfasfas','complete','success','sadfadsfasdfasdfasdfasdfsdafds'),(68,8,2,'',NULL,NULL,NULL,'pending fill','warning',NULL),(79,8,2,'project topic new changes','Conference','feedback feedback ','Additional commentsAdditional comments','complete','success','otherotherother'),(80,8,2,'bla bla bla','bla bla bla','bla bla bla','Additional commentsAdditional commentsAdditional commentsAdditional comments','pending fill','warning','bla bla bla'),(81,8,2,'Project Project Project Project ','Project Project Project ','Project Project Project ','Project Project Project ','pending validation','warning','Project Project Project '),(82,8,2,'asdf 3423 . , _',NULL,NULL,NULL,'pending fill','warning',NULL),(83,8,2,'',NULL,NULL,NULL,'pending fill','warning',NULL),(85,8,2,'',NULL,NULL,NULL,'pending fill','warning',NULL);
...
INSERT INTO `student` VALUES (8,1223344,'emai@email.com','James','Potter','6983827751',NULL,NULL,3),(9,234424,'emai@email.com1','Sirious','Black','6983827750',NULL,NULL,3);
...
INSERT INTO `student_brought_along` VALUES (61,0,0,0,0,0,0,NULL,NULL),(62,0,0,0,0,0,0,NULL,NULL),(64,0,0,0,0,0,0,NULL,NULL),(67,1,1,1,1,1,1,'asdfasdfasdfasdfsfs','ASDFASDFASDF'),(68,0,0,0,0,0,0,NULL,NULL),(79,1,1,1,1,1,1,'exercise','other'),(80,0,1,0,0,0,0,'ex asdf ',' ads das fsd f asf'),(81,1,0,1,1,0,0,NULL,NULL),(82,1,1,0,1,1,0,NULL,NULL),(83,0,0,0,0,0,0,NULL,NULL),(85,0,0,0,0,0,0,NULL,NULL);
...
INSERT INTO `term` VALUES (9,'Fall Semester 2015','2014-09-02 15:59:00','2015-01-14 16:59:00');
...
INSERT INTO `tutor_has_course_has_term` VALUES (19,10,9,9);
...
INSERT INTO `user` VALUES (17,'r.dokollari@gmail.com','admin','Dokollari','$2y$10$6Y76z7PxHON5N4qOVkxLfu9mmNhg6068pOWMejx/RpwfeUHi4kpN.','assets/img/avatars/avatar_img_17.jpg','2014-09-24 11:37:53',7,'6983827751',NULL,1,'54267455cff021.11763509HJPXTYLROA','2014-09-27 08:24:53'),(18,'emai@email.com','first','Dokollari','$2y$10$TNd6cKv9XHGjybeQjfjI6Ov4ZUqXStvWR3Bs4Jl4ZPcbyk2OgWOlS','assets/img/avatars/default_avatar.jpg','2014-09-24 12:55:12',8,NULL,NULL,1,'','2014-09-26 03:00:19'),(19,'r.dokollari@acg.edu','tutor','last name','$2y$10$9XAgZJ8gXdDri1eya72uReqmTy3yU3PE79PhY6uXxPh7.k0OvcPKW','assets/img/avatars/default_avatar.jpg','2014-09-26 07:02:59',8,'6983827752','bla bla.',1,'','2014-09-27 13:17:10'),(20,'emai@email.com2','first','last',NULL,'assets/img/avatars/default_avatar.jpg','2014-09-27 08:27:58',8,NULL,NULL,1,'5426750ed57383.68051513VTNHUFBLQE','2014-09-27 08:27:58'),(21,'emai@email.com5','first','last',NULL,'assets/img/avatars/default_avatar.jpg','2014-10-03 03:27:21',8,NULL,NULL,1,'542e179a031ff0.00479269OBYGVEKFNI','2014-10-03 03:27:22'),(23,'emai@email.com3','first tutor','last',NULL,'assets/img/avatars/default_avatar.jpg','2014-10-13 09:36:55',8,NULL,NULL,1,'543b9d379a7de8.70357662MNHPFKXBYC','2014-10-13 09:36:55'),(24,'emai@email.com23','secretary','asdf','$2y$10$ZDNtYCR7MGe59SSE8oQCC.YcFDEYIiIU2D5kcrWG5pkOmvEeE8XBS','assets/img/avatars/default_avatar.jpg','2014-10-14 15:00:41',9,NULL,NULL,1,'','2014-10-16 12:51:18');
...
-- Dump completed on 2014-10-25  4:34:32
