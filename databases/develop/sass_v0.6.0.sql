...
CREATE TABLE `appointment` (
  ...
  CONSTRAINT `fk_appointment_schedule1` FOREIGN KEY (`schedule_id`) REFERENCES `sass-ms_db`.`term` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `term` VALUES (1,'Fall','0000-00-00 00:00:00','0000-00-00 00:00:00'),(2,'Fall Semester 2014','0000-00-00 00:00:00','0000-00-00 00:00:00'),(3,'Fall11','0000-00-00 00:00:00','0000-00-00 00:00:00'),(4,'Fall112','0000-00-00 00:00:00','0000-00-00 00:00:00'),(5,'Fall Semester 201435','0000-00-00 00:00:00','0000-00-00 00:00:00'),(6,'Fall Semester 2014353','0000-00-00 00:00:00','0000-00-00 00:00:00'),(7,'Fall Semester 20143533','0000-00-00 00:00:00','0000-00-00 00:00:00'),(8,'d','0000-00-00 00:00:00','0000-00-00 00:00:00'),(9,'de','0000-00-00 00:00:00','0000-00-00 00:00:00'),(10,'3f','2014-09-15 12:40:00','2014-10-17 13:10:00'),(11,'dsf','2014-09-15 12:43:00','2014-11-28 14:10:00');
...
CREATE TABLE `tutor_has_course_has_schedule` (
  ...
  KEY `fk_tutor_has_course_has_schedule_schedule1_idx` (`schedule_id`),
  ...
  CONSTRAINT `fk_tutor_has_course_has_schedule_schedule1` FOREIGN KEY (`schedule_id`) REFERENCES `sass-ms_db`.`term` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (0,'admin@acg.edu','','','$2y$10$r.q9o4vcqqDkwyKCoYvKq.Mm1N2JzQoI/mMt9kwHamn7CVtwbl2Km','assets/img/avatars/default_avatar.jpg','2014-09-15 10:11:17',19,NULL,NULL,1,'','2014-09-15 10:10:58');
...
CREATE TABLE `work_week_hours` (
  ...
  CONSTRAINT `fk_work_day_schedule1` FOREIGN KEY (`schedule_id`) REFERENCES `sass-ms_db`.`term` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-09-15 15:47:26
