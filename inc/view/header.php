...
<head>
	...
	<link rel="stylesheet" href="<?php BASE_URL; ?>js/plugins/icheck/skins/minimal/blue.css" type="text/css" />
	<link rel="stylesheet" href="<?php BASE_URL; ?>js/plugins/select2/select2.css" type="text/css" />
	<link rel="stylesheet" href="<?php BASE_URL; ?>js/plugins/fullcalendar/fullcalendar.css" type="text/css" />
	...
	<header id="header">
		...
		<h1 id="site-logo">
			<a href="<?php BASE_URL; ?>index.php">
				<img src="<?php BASE_URL; ?>img/logos/logo.png" alt="Site Logo" />
			</a>
		</h1>
		...
		<ul class="nav navbar-nav pull-right">
			<li class="dropdown">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li class="divider"></li>
					<li>
						<a href="<?php BASE_URL; ?>page-login.html">
