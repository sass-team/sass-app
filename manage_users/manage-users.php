					    ...
					    <div class="row">
					    	...
					    	<div class="col-md-3 col-sm-5">
							    ...
							    <ul id="myTab" class="nav nav-pills nav-stacked">
							        <li class="active"><a href="#add" data-toggle="tab"><i class="fa fa-plus"></i> &nbsp;&nbsp;Add User</a></li>
							...
							<div class="col-md-9 col-sm-7">
								...
								<div id="myTabContent" class="tab-content stacked-content">
									<div class="tab-pane fade in active" id="add">
										<p>In this section admin is able to add a new user and fill out the appropriate fields. Only necessary fields are required in order to create a new user. Users(tutors or secretaries) are able to modify their profile once they are logged in.</p>
										<p>
