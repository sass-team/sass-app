...
<div id="content">
	...
	<div id="content-container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="alert alert-info" role="alert"><strong>Course: </strong>CS1070 <strong>Date: </strong>25/09/2014</div>
				<div class="list-group">

						<a href="javascript:;" class="list-group-item">
							<h5><i class="fa fa-file-text-o"></i> &nbsp;&nbsp;R-036582 <span class="label label-success">Submitted</span></h5>
							Student Name: George Papadopoulos
						</a>

						<a href="javascript:;" class="list-group-item">
							<h5><i class="fa fa-file-text-o"></i> &nbsp;&nbsp;R-0335698 <span class="label label-success">Submitted</span></h5>
							Student Name: John Pappas
						</a>

						<a href="javascript:;" class="list-group-item">
							<h5><i class="fa fa-file-text-o"></i> &nbsp;&nbsp;R-028756 <span class="label label-warning">Pending</span></h5>
							Student Name: Rizart the Coder
						</a>

						<a href="javascript:;" class="list-group-item">
							<h5><i class="fa fa-file-text-o"></i> &nbsp;&nbsp;R-0215893 <span class="label label-success">Submitted</span></h5>
							Student Name: Philip Asshole
						</a>
