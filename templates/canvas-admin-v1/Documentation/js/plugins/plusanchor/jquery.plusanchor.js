        ...
        base.init = function(){
            ...
            base.$el.find('a[href^="#"]').click(function( e ) {
                ...
                var $this = $(this);
                    ...
                    $customOffset = (base.options.offset) ? base.options.offset : 0 ;
										$scrollTo = (($(href).offset().top - $customOffset) < 0) ? 0 : $customOffset ;
                ...
                if ( $(href).length ){
                    ...
                    $(base.scrollEl).animate({
                        ...
                        scrollTop: $(href).offset().top - $scrollTo
                    ...
                    $(base.scrollEl).animate({
                        scrollTop: $name.offset().top - $scrollTo
                    }, base.options.speed, base.options.easing);
